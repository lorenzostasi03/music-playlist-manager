...
class SongTest {
	...
	/**
	 * Verifica che una traccia creata con dati validi abbia tutti i campi impostati
	 * correttamente e che l'ID non sia nullo.
	 */
	@Test
	...
	/**
	 * Verifica che la creazione di una traccia con titolo vuoto lanci
	 * {@link IllegalArgumentException}.
	 */
	@Test
	void testTitoloVuotoLanciaEccezione() {
		assertThrows(IllegalArgumentException.class, () -> new Song("", "Queen", Genre.ROCK, 1975, 354, "/path.mp3"));
	}

	/**
	 * Verifica che la creazione di una traccia con titolo null lanci
	 * {@link IllegalArgumentException}.
	 */
	@Test
	void testTitoloNullLanciaEccezione() {
		assertThrows(IllegalArgumentException.class, () -> new Song(null, "Queen", Genre.ROCK, 1975, 354, "/path.mp3"));
	}

	/**
	 * Verifica che la creazione di una traccia con autore vuoto lanci
	 * {@link IllegalArgumentException}.
	 */
	@Test
	void testAutoreVuotoLanciaEccezione() {
		assertThrows(IllegalArgumentException.class, () -> new Song("Titolo", "", Genre.ROCK, 1975, 354, "/path.mp3"));
	}
	...
	/**
	 * Controlla che la durata totale in secondi venga convertita correttamente in
	 * una stringa nel formato classico "minuti:secondi".
	 */
	@Test
	...
	/**
	 * Assicura che la formattazione aggiunga lo zero iniziale quando i secondi
	 * rimanenti sono inferiori a 10 (es. "1:05" e non "1:5").
	 */
	@Test
	...
	/**
	 * Verifica che il contatore delle riproduzioni aumenti esattamente di uno ad
	 * ogni singola chiamata del metodo.
	 */
	@Test
