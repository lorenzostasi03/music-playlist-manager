...
class PlaylistTest {
	...
	/**
	 * Verifica che aggiungere lo stesso brano nella playlist due volte lanci
	 * un'eccezione.
	 */
	@Test
	...
	void testGetSongsListaImmutabile() {
		assertThrows(UnsupportedOperationException.class, () -> playlist.getSongs().add(song1));
	}

	/**
	 * Controlla che sia possibile recuperare un brano specifico fornendo la sua
	 * esatta posizione (indice) all'interno della playlist.
	 */
	@Test
	void testGetSongAt() {
		playlist.addSong(song1);
	...
	/**
	 * Assicura che la ricerca di un brano in una posizione inesistente lanci
	 * un'eccezione.
	 */
	@Test
	...
	/**
	 * Verifica che rimuovere una traccia dalla playlist non presente lanci
	 * un'eccezione.
	 */
	@Test
	...
	/**
	 * Verifica che se sposto un brano in una nuova posizione (es. lo porto in
	 * cima), la lista deve aggiornarsi di conseguenza.
	 */
	@Test
	void testMoveSong() {
		playlist.addSong(song1);
	...
	/**
	 * Verifica che spostare un brano in una posizione non valida lanci
	 * un'eccezione.
	 */
	@Test
	...
	/**
	 * Controlla che le statistiche di ascolto dell'intera playlist avanzino di
	 * un'unità ad ogni riproduzione registrata.
	 */
	@Test
