...
class PlaylistCatalogTest {
    ...
    /**
     * Il sistema non deve permettere di avere due playlist chiamate allo stesso modo.
     */
    @Test
    ...
    /**
     * Verifica che una playlist presente nel catalogo possa essere rimossa correttamente.
     */
    @Test
    ...
    /**
     * Verifica che rimuovere una playlist non presente nel catalogo lanci un'eccezione.
     */
    @Test
    ...
    /**
     * Verifica che chiamare una nuova playlist con un nome già usato da un'altra playlist
     * restituisca true.
     */
    @Test
    ...
    /**
     * Assicura che il controllo sul nome permetta il salvataggio se l'utente
     * lascia il nome inalterato.
     */
    @Test
    ...
    /**
     * Controlla che la ricerca incrociata funzioni correttamente:
     * se cerco una canzone specifica, il catalogo deve restituirmi
     * solo le playlist in cui quel brano è stato effettivamente aggiunto.
     */
    @Test
    ...
    /**
     * Verifica che passando una traccia nulla,
     * il sistema non vada in crash ma gestisca il caso restituendo una lista vuota.
     */
    @Test
    ...
    /**
     * Garantisce che la lista delle playlist restituita dal catalogo sia in sola lettura,
     * in modo da prevenire modifiche accidentali o indesiderate dall'esterno della classe.
     */
    @Test
    void testGetAllPlaylistsImmutabile() {
        assertThrows(UnsupportedOperationException.class,
            () -> catalog.getAllPlaylists().add(p1));
    }
}
