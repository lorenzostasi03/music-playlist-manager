...
public class DialogUtil {
	...
	/**
	 * Apre una finestra modale caricata da FXML e permette di inizializzare il suo
	 * controller.
	 *
	 * @param fxml
	 *            file FXML della view da caricare
	 * @param title
	 *            titolo mostrato nella finestra
	 * @param owner
	 *            finestra principale che “possiede” il dialog
	 * @param controllerInit
	 *            funzione per configurare il controller appena creato
	 */
