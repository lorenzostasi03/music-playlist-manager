...
public class HomeController implements Initializable, Refreshable {
	...
	/**
	 * Apre la finestra per la creazione di una nuova playlist oppure per la
	...
	/**
	 * Crea un pulsante di azione standard utilizzato nelle righe delle playlist.
	 *
	 * @param text
	 *            testo visualizzato sul pulsante
	 * @param tooltip
	 *            descrizione mostrata al passaggio del mouse
	 * @param action
	 ...
	 *
	 * @param playlist
	 *            playlist di cui calcolare la durata
