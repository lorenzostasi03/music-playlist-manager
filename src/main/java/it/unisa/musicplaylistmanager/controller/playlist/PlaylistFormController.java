...
/**
 * Controller per la finestra modale dedicata alla creazione di una nuova playlist
 * o alla rinomina di una playlist esistente.
 */
public class PlaylistFormController {
     ...
     *
     * @param playlist playlist esistente da modificare
     */
    ...
    /**
     * Gestisce il salvataggio o la modifica della playlist.
     * Valida l'input e, in caso di successo, aggiorna la libreria e chiude la finestra.
     */
    @FXML
