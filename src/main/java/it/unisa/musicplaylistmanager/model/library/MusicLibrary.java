...
public class MusicLibrary {
     ...
     *
     * @throws PersistenceException se si verifica un errore durante il caricamento dal database
     */
    public void init() {
     ...
     * @throws IllegalArgumentException se la traccia non è valida
     * @throws DuplicatedSongException se la traccia è già presente nel catalogo
     * @throws PersistenceException se si verifica un errore durante il salvataggio nel database
     */
     ...
     * @throws IllegalArgumentException se la traccia è null o non presente nel catalogo
     * @throws PersistenceException se si verifica un errore durante la rimozione dal database
     */
    public void removeSongFromCatalog(Song song) {
        if (!songCatalog.contains(song)) return;

        List<Playlist> playlistsWithSong =
     ...
     *
     * @param song brano da aggiornare.
     * @throws PersistenceException in caso di errore durante l'operazione di persistenza.
     */
     ...
     * @throws IllegalArgumentException se la playlist è null
     * @throws DuplicatedPlaylistException se esiste già una playlist con lo stesso nome
     * @throws PersistenceException se si verifica un errore durante il salvataggio nel database
     */
     ...
     * @throws IllegalArgumentException se la playlist è null o non presente
     * @throws PersistenceException se si verifica un errore durante la cancellazione
     */
     ...
     * @throws IllegalArgumentException se playlist o nome non sono validi
     * @throws DuplicatedPlaylistException se esiste già una playlist con lo stesso nome
     * @throws PersistenceException se si verifica un errore durante l'aggiornamento nel database
     */
     ...
     * @throws IllegalArgumentException se il brano non è nel catalogo
     * @throws PersistenceException se si verifica un errore durante l'operazione sul database
     */
     ...
     * @throws PersistenceException se si verifica un errore durante la rimozione
     */
